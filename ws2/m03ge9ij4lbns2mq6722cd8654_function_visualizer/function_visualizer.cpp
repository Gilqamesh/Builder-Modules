...
m03ge9ij49xkr5obofujoj7ltw_function_runtime::function_t* current_function = nullptr;

m03ge9ij4ec2ss9jnrfdsrjm1q_function_repository::function_repository_t function_repository;
m03ge9ij4fjvyaf48asgpm6fdt_function_ir_file_repository::function_ir_file_repository_t function_ir_file_repository("functions");
...
*/
rec_t to_view(m03ge9ij49xkr5obofujoj7ltw_function_runtime::function_t* function, rec_t view_rec, rec_t world_rec) {
    assert(function);
...
m03ge9ij49xkr5obofujoj7ltw_function_runtime::function_t* created_function = nullptr;

m03ge9ij4ji4x4hp1tu5011uc8_function_visualizer_editor::function_visualizer_editor_t editor;

m03ge9ij49xkr5obofujoj7ltw_function_runtime::function_t* dragged_function = nullptr;
...
void update_key_event(float dt) {
    if ((IsKeyDown(KEY_LEFT_CONTROL) || IsKeyDown(KEY_RIGHT_CONTROL)) && IsKeyPressed(KEY_S)) {
        ...
        m03ge9ij49xkr5obofujoj7ltw_function_runtime::function_t* function_to_save = current_function;
...
void update_mouse_event(float dt) {
    ...
    if (IsMouseButtonPressed(MOUSE_BUTTON_LEFT)) {
        if (!editor.open()) {
            ...
            m03ge9ij49xkr5obofujoj7ltw_function_runtime::function_t* hit_function = nullptr;
            ...
            if (!dragged_function) {
                if (hit_function) {
                    ...
                    if (!created_function) {
                        created_function = m03ge9ij4d9wyfmdsr8oyhkktr_function_compound::function_compound_t::function(typesystem, m03ge9ij46lc986vpdamnc2fka_function_ir::function_ir_t {});
...
void draw_function(m03ge9ij49xkr5obofujoj7ltw_function_runtime::function_t* function, rec_t view_rec, rec_t world_rec) {
...
void draw_functions(m03ge9ij49xkr5obofujoj7ltw_function_runtime::function_t* function, rec_t view_rec, rec_t world_rec) {
    for (m03ge9ij49xkr5obofujoj7ltw_function_runtime::function_t* child : function->children()) {
...
void exec() {
    ...
    m03ge9ij49xkr5obofujoj7ltw_function_runtime::function_t* canvas_function = m03ge9ij4d9wyfmdsr8oyhkktr_function_compound::function_compound_t::function(typesystem, m03ge9ij46lc986vpdamnc2fka_function_ir::function_ir_t {
