...
extern "C" void phase__source(const m03gagbhsujjf63n0w3r2w4q6h_build_phases::source_phase_t* phase) {
    ...
    const auto raylib_tar_gz = m03gagbht7wqhtdg9hwdpmfn5o_download::fetch(
    ...
    const auto raylib_tar = m03gagbht9a02hx1qrv2qfgnp7_gzip::ungzip(
        raylib_tar_gz,
        phase->build_dir() / m03gagbhsnusi43zogoacgj2ez_filesystem::relative_path_t("raylib-5.5.tar")
    );
    const auto raylib_extract_dir = m03gagbhteldyu7ptbgnvootmb_tar::untar(
        raylib_tar,
...
extern "C" void phase__library(const m03gagbhsujjf63n0w3r2w4q6h_build_phases::library_phase_t* phase) {
    ...
    m03gagbht3svcx3ign454lfup3_cmake::configure(raylib_source_dir, cmake_build_dir, {
