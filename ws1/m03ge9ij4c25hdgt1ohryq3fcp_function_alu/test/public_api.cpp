...
void expect_identity(
    ...
    test::expect_equal(
        function.function_ir().function_id.ns,
        std::string("function_alu")
    );
    test::expect_equal(function.function_ir().function_id.name, name);
    test::expect(static_cast<bool>(function.function_ir().function_id));
    test::expect(function.function_ir().children.empty());
    test::expect(function.function_ir().connections.empty());
}
...
int main() {
    return test::run([] {
        ...
        add->write(1, 23);
        add->call(0);
        test::expect_equal(static_cast<int>(add->read(2)), 42);
        add->write(0, -5);
        add->write(1, 2);
        add->call(1);
        test::expect_equal(static_cast<int>(add->read(2)), -3);
        ...
        sub->write(1, 8);
        sub->call(0);
        test::expect_equal(static_cast<int>(sub->read(2)), 42);
        ...
        mul->write(1, 7);
        mul->call(1);
        test::expect_equal(static_cast<int>(mul->read(2)), 42);
        ...
        div->write(1, 2);
        div->call(0);
        test::expect_equal(static_cast<int>(div->read(2)), 42);
        div->write(0, -21);
        div->write(1, 3);
        div->call(1);
        test::expect_equal(static_cast<int>(div->read(2)), -7);
        ...
        cond->write(0, true);
        cond->call(0);
        test::expect_equal(static_cast<int>(cond->read(3)), 11);
        cond->write(0, false);
        cond->call(0);
        test::expect_equal(static_cast<int>(cond->read(3)), 22);
        cond->clear(1);
        cond->write(0, true);
        cond->call(0);
        test::expect_equal(static_cast<int>(cond->read(3)), 22);
        ...
        is_zero->write(0, 0);
        is_zero->call(0);
        test::expect_equal(static_cast<bool>(is_zero->read(1)), true);
        is_zero->write(0, 9);
        is_zero->call(0);
        test::expect_equal(static_cast<bool>(is_zero->read(1)), false);
        ...
        integer->write(0, 123);
        integer->call(0);
        test::expect_equal(static_cast<int>(integer->read(0)), 0);
        ...
        logger->call(0);
        test::expect_equal(explicit_output.str(), std::string("42\n"));
        ...
        test::expect_equal(fallback_output.str(), std::string("-7\n"));
        ...
        test::expect_equal(static_cast<int>(first_sink.read(0)), 314);
        test::expect_equal(static_cast<int>(second_sink.read(0)), 314);
        test::expect_equal(static_cast<int>(pin->read(1)), 314);
        test::expect_equal(static_cast<int>(pin->read(2)), 314);
        ...
        pin->call(1);
        test::expect_equal(g_sink_call_count, 2);
        test::expect_equal(static_cast<int>(second_sink.read(0)), 271);
        test::expect_equal(static_cast<int>(pin->read(2)), 271);
    });
}
