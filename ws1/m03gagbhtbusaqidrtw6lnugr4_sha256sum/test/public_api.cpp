...
int main() {
    return test::run([] {
        ...
        test::expect(filesystem_api::is_regular_file(file));
        test::expect(!filesystem_api::exists(file + ".sha256"));
        ...
        test::expect(filesystem_api::is_regular_file(checksum_path));
        ...
        test::expect(filesystem_api::is_regular_file(file));
        test::expect(!filesystem_api::exists(checksum_path));
    });
}
